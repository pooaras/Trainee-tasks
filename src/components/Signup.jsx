...
const Signup = () => {
  ...
  const submitData = (mail, pass) => {
    window.localStorage.setItem(mail, pass)
    window.sessionStorage.setItem(mail, pass)
    alert("sign up..account created...");
  }
